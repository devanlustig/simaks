...
<div class="page-heading">
    <div class="card-body">
        <div class="row">
            <div class="col-12 col-md-4 order-md-1 order-last">
                ...
                <form action="{{ route('matakuliah.download') }}" method="POST">
                    @csrf

                    <!-- @can('Matakuliah Trash')
                        <a href="{{ route('matakuliah.trash') }}" class="btn icon icon-left btn-danger btn-sm me-1 mb-1">
                            <i class="fas fa-trash"></i>
                            All Trash
                        </a>
                    @endcan

                    @can('Matakuliah Excel')
                    ...
                    @can('Matakuliah Create')
                        <a href="{{ route('matakuliah.create') }}" class="btn icon icon-left btn-primary btn-sm me-1 mb-1">
            ...
            <div class="col-12 col-md-4 order-md-1 order-first">
                <h3>Master Matakuliah</h3>
            </div>
            <div class="col-12 col-md-4 order-md-2 order-last">
                <nav aria-label="breadcrumb" class="breadcrumb-header float-start float-lg-end">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">Data Master</li>
                        <li class="breadcrumb-item active" aria-current="page">Master Matakuliah</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <section class="section">
        <div class="card">
            <div class="card-body">
                <table class="table table-hover table-striped" id="tableMatakuliah">
                    <thead class="table-dark">
                        <tr>
                            <th class="text-left" width="20px">No.</th>
                            <th class="text-left" width="70px">Matakuliah</th>
                            <th class="text-left" width="70px">SKS</th>
...
@include('master.matakuliah.table.matakuliah')
@include('master.matakuliah.js.trash')
@endpush
